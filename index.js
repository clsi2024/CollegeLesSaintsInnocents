function galerie() {
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="clsi1.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi2.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi3.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi4.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi5.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi6.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi7.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi8.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi9.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi10.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi11.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi12.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi13.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi14.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi15.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi16.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi17.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi18.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi19.jfif" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi20.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
      <div class="carousel-item">
        <img src="clsi21.jpg" class="d-block w-100" alt="..." style="width: 50%; height: 50%;">
      </div>
    </div>
